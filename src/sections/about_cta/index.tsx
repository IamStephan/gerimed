    ...
    <section className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-screen-sm sm:text-center sm:mx-auto">
        ...
        <h2 className="mb-4 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
          ...
          your next <span className="inline-block text-red-700">journey</span>
        </h2>
        <p className="text-base text-gray-700 md:text-lg sm:px-4">
          Gerimed specializes in elderly health care giving you peace of mind.
          We are located in Langebaan and in Kleinmond giving you the option of
          choosing the closest home. Contact us for more information.
        </p>
